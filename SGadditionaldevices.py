    ...
    while True:
        try:
            ...
            if additionaldev == "y":
                ...
                while True:
                    try:
                        additangle1 = int(input(f"What is the angle of additional device #{devnumber}?: ")).strip()
                        break
                    except ValueError:
                        continue
                while True:
                    try:
                        ...
                        if additionaldev2 == "y":
                            ...
                            while True:
                                try:
                                    additangle2 = int(input(f"What is the angle of additional device #{devnumber}?: ")).strip()
